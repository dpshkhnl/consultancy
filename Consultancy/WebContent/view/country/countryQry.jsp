					...
					<table id="example" class="display table-responsive" width="100%"
						...
						<thead>
							<tr>
								...
								<th style="text-align: center"><u><a
										class="btn btn-warning" href="Country?action=INS"
						...
						<tbody>
							<c:forEach var="n" items="${lista}">
								<tr>
									<td style="display: none;">${n.countryId}</td>
									...
									<td style="text-align: center"><a class="btn btn-warning"
										href="Country?action=DEL&id=${n.countryId}" role="button">
											<span class="glyphicon glyphicon-trash"></span>
									</a></td>
									<td style="text-align: center"><a class="btn btn-warning"
										href="Country?action=UPD&id=${n.countryId}" role="button">
